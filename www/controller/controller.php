...
switch($view){
    ...
    case('archive'):
        ...
        $perpage = 2; // кол-во новин на страницу
        if(isset($_GET['page'])){
            $page = (int)$_GET['page'];
            if($page < 1) $page = 1;
        }else{
    ...
    case('cat'):
        ...
        $order_p = array(
                        ...
                        'datea' => array('по даті додавання - до останніх', 'data ASC'),
                        'dated' => array('по даті додавання - з останніх', 'data DESC'),
        ...
        $brand_name = brand_name($category);// хлібні крошкі
    ...
    break;
     ...
     case('product'):
        ...
        if($goods_id){
            ...
            if($googs)$brand_name1 = brand_name($goods['goods_brandid']); // хлібні крошки
        }
    break;
