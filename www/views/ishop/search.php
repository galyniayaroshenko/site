...
<div class="product-table">
    ...
    <div class="product-table-img">
		<a href="?view=product&amp;goods_id=<?=$result_search[$i]['goods_id']?>"><img src="<?=PRODUCTIMG?><?=$result_search[$i]['img']?>" alt="" width="64" /></a>
		<div> <!-- Иконки -->
            <?php if($result_search[$i]['hits']) echo '<img src="' .TEMPLATE. 'images/ico-cat-lider.png" alt="лідери продажів" />'; ?>
            <?php if($result_search[$i]['new']) echo '<img src="' .TEMPLATE. 'images/ico-cat-new.png" alt="новинка" />'; ?>
            <?php if($result_search[$i]['sale']) echo '<img src="' .TEMPLATE. 'images/ico-cat-sale.png" alt="розпродаж" />'; ?>							
		</div> <!-- Иконки -->
	</div>
    </div>
	<p class="cat-table-more"><a href="?view=product&amp;goods_id=<?=$result_search[$i]['goods_id']?>">детальніше...</a></p>
	<p>Ціна :  <span><?=$result_search[$i]['price']?></span></p>
